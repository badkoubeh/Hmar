<%@ page language="C#" autoeventwireup="true" inherits="h_ship_ins, LastDll" masterpagefile="~/HomerMasterPages.master" enableviewstatemac="false" enableEventValidation="false" %>
    ...
    <div class="normalheader transition animated fadeIn">
        <div class="hpanel">
            <div class="panel-body">
                ...
                <small>شما می توانید کشتی خود را به لیست اضافه نمایید </small>
            </div>
        </div>
    </div>
