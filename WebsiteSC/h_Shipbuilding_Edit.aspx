<%@ page language="C#" autoeventwireup="true" inherits="h_Shipbuilding_Edit, LastDll" masterpagefile="~/HomerMasterPages.master" enableviewstatemac="false" enableEventValidation="false" %>
            ...
            <div class="panel-body">
                ...
                <div id="hbreadcrumb" class="pull-left m-t-lg">
                    <ol class="hbreadcrumb breadcrumb">
                        ...
                        <li>
                            <a href="h_Shipbuilding_view.aspx" class="btn btn-info btn-sm"> کشتی سازی های من<i class="fa fa-eye"></i></a>
                        </li>
                    </ol>
                </div>
                <h2 class="font-light m-b-xs">کشتی سازی جدید
                </h2>
                <small>شما می توانید اطلاعات کشتی سازی خود را ویرایش  نمایید </small>
            </div>
        </div>
    </div>
