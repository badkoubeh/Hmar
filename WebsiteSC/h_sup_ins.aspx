<%@ page language="C#" autoeventwireup="true" inherits="h_sup_ins, LastDll" enableviewstate="true" masterpagefile="~/HomerMasterPages.master" enableviewstatemac="false" enableEventValidation="false" %>
    ...
    <div class="normalheader transition animated fadeIn">
        <div class="hpanel">
            <div class="panel-body">
                ...
                <small>شما می توانید تجهیزات  خود را به لیست اضافه نمایید </small>
            </div>
        </div>
    </div>
                                ...
                                <div class="col-sm-10 col-sm-pull-2">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-md-push-6">
                                            <asp:DropDownList runat="server" ID="txtGroupMaster" placeholder="" class="form-control" OnSelectedIndexChanged="txtGroupMaster_SelectedIndexChanged"
                                        ...
                                        <div class="col-md-6 col-md-pull-6">
                                            <asp:DropDownList runat="server" ID="txtGroupDte" placeholder="" onkeypress='return isNumberKey(event);' class="form-control" DataValueField="ID" DataTextField="StatuceName" />
                                        </div>
