<%@ page language="C#" autoeventwireup="true" inherits="Adminstration_ContantEdit, LastDll" masterpagefile="~/Adminstration/admin.master" validaterequest="false" enableviewstatemac="false" enableEventValidation="false" %>
							  ...
							  <div class="controls">
                               ...
                               <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <asp:DropDownList  data-rel="chosen" runat="server" id="txtPakKind" DataTextField="StatuceName" DataValueField="ID">
